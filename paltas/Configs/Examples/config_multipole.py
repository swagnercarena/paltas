...
config_dict = {
	...
	'main_deflector':{
		...
		'parameters':{
			...
			'ra_0':0.0, 'dec_0':0.0,
			'mult2_a':uniform(loc=0,scale=0.02).rvs,
			'mult2_phi':uniform(loc=0,scale=2*np.pi).rvs,
			'mult2_center_x':norm(loc=0.0,scale=0.16).rvs,
			'mult2_center_y':norm(loc=0.0,scale=0.16).rvs,
			'mult3_a':uniform(loc=0,scale=0.02).rvs,
			'mult3_phi':uniform(loc=0,scale=2*np.pi).rvs,
			'mult3_center_x':norm(loc=0.0,scale=0.16).rvs,
			'mult3_center_y':norm(loc=0.0,scale=0.16).rvs,
			'mult4_a':uniform(loc=0,scale=0.02).rvs,
			'mult4_phi':uniform(loc=0,scale=2*np.pi).rvs,
			'mult4_center_x':norm(loc=0.0,scale=0.16).rvs,
			'mult4_center_y':norm(loc=0.0,scale=0.16).rvs}
	},
	'source':{
