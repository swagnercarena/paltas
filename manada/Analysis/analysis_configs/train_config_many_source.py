...
tfr_train_paths = ['/scratch/users/swagnerc/manada/datasets/more_500k/%06d/tf_record_%d'%(i,i) for i in range(1,451)]
...
# for training
npy_folders_train = [
	'/scratch/users/swagnerc/manada/datasets/more_500k/%06d/'%(i)
