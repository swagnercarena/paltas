...
# for training
npy_folders_train = [
	'/scratch/users/swagnerc/manada/datasets/ss_no_sub_%d/'%(i)
	for i in range(1,21)]
# The path to the fodler containing the npy images
# for validation
npy_folder_val = '/scratch/users/swagnerc/manada/datasets/ss_no_sub_val/'
# The path to the training metadata
metadata_paths_train = [
	'/scratch/users/swagnerc/manada/datasets/ss_no_sub_%d/metadata.csv'%(i)
	for i in range(1,21)]
# The path to the validation metadata
metadata_path_val = (
	'/scratch/users/swagnerc/manada/datasets/ss_no_sub_val/metadata.csv')
